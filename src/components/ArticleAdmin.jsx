  ...
  return (
    <div className="w-full">
      ...
      <div className="">
        <NavbarAdmin />
        {isCreate ? (
          <CreateArticle setIsCreate={setIsCreate} />
        ) : (
          <main className="pt-6 px-4 sm:px-6 pb-6 bg-gray-100 min-h-screen">
            <div className="flex flex-col">
              <div className="bg-gray-50 p-4 sm:p-6 rounded-t-lg">
                <h2 className="text-sm sm:text-base font-[500]">
                  Total Articles: {articleCategory?.data.length}
                </h2>
              </div>
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectGroup>
                        ...
                        <SelectItem className="text-black" value="Semua">
                          Semua Kategory
                        </SelectItem>
                      </SelectGroup>
                    </SelectContent>
                  ...
                  <Table className="min-w-full">
                    <TableHeader>
                      <TableRow>
                        ...
                        <TableHead className="text-center px-2 sm:px-4 hidden sm:table-cell">
                          Category
                        </TableHead>
                        <TableHead className="text-center px-2 sm:px-4 hidden md:table-cell">
                          Created at
                        </TableHead>
                        <TableHead className="text-center px-2 sm:px-4">
                          Action
                          ...
                          <TableCell className="text-center px-2 sm:px-4">
                            <div className="flex flex-col sm:flex-row gap-1 justify-center items-center">
                              ...
                              >
                                <Button
                                  variant="link"
                                  className="text-blue-600 cursor-pointer p-0 sm:px-4 text-xs sm:text-sm"
                                >
                                  Preview
                                </Button>
                              </Link>
                              ...
                              >
                                ...
                                <DialogContent className="sm:max-w-md">
                                  <DialogHeader>
                                    ...
                                    <DialogDescription>
                                      Deleting this article is permanent and
                                      cannot be undone. All related content will
                                      be removed.
                                    </DialogDescription>
                                  </DialogHeader>
